    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-blue-500/30">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden flex flex-col items-center justify-center text-center px-6">
        ...
        <p className="text-lg lg:text-xl text-slate-400 max-w-2xl mx-auto mb-10">
          Add typo-tolerant, instant search to your documentation, blog, or
          ecommerce site in minutes. No complex infrastructure to manage.
        </p>
      ...
      <section
        id="features"
        className="py-24 bg-slate-900/50 border-y border-white/5 px-6"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              Everything you need in a search engine
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto">
              Built on top of powerful open-source technologies, optimized for
              the modern web.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Built-in tolerance for spelling mistakes. Don't lose customers just because of a typo.",
                icon: 'M3 4h13M3 8h9m-9 4h6m4 0l4-4m0 0l4 4m-4-4v12',
              },
              {
                title: 'Auto Crawling',
                desc: "Just provide your domain or sitemap. We'll automatically crawl and index your content.",
                icon: 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9',
              },
              {
                title: 'Drop-in Widget',
                desc: 'Install our search widget with just two lines of code. Instantly beautiful UI out of the box.',
                icon: 'M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4',
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl bg-slate-800/50 border border-white/5 hover:border-blue-500/50 transition-colors group"
              >
      ...
      <footer className="py-12 text-center text-slate-500 border-t border-white/10 mt-20 px-6">
        <p>
          &copy; {new Date().getFullYear()} SearchSAAS. All rights reserved.
        </p>
      </footer>
    </div>
  );
