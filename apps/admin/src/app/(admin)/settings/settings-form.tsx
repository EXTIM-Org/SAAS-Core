...
export function SettingsForm({
  ...
  const [interval, setInterval] = useState(
    initialSettings.defaultAutoCrawlIntervalDays.toString(),
  );
    ...
    <form onSubmit={handleSubmit}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure the default interval for automatic background crawling of
            domains.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              New domains will use this interval. You can override it per domain
              later.
            </p>
          </div>
        </CardContent>
